...
fn trailing_newline_span() {
    let input = &[
        Level::ERROR.primary_title("Extra newline at end of file").id("W391").is_fixable(true).element(
            Snippet::source("    foo()\n    bar()\n\n")
                .path("W391_0.py")
                .line_start(12)
                .annotation(AnnotationKind::Primary.span(20..21)).fold(false),
        ),
    ];
    let expected_ascii = str![[r#"
...
fn multi_newline_span() {
    let input = &[
        Level::ERROR.primary_title("Too many newlines at end of cell").id("W391").is_fixable(true).element(
            Snippet::source("\n\n")
                .path("W391.ipynb")
                .line_start(19)
                .annotation(AnnotationKind::Primary.span(0..2)).fold(false),
        ),
    ];
    let expected_ascii = str![[r#"
